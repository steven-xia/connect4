...
static const char __pyx_k_file_evaluate_py_description_co[] = "\nfile: evaluate.py\n\ndescription: contains code for evaluating a game position.\n";
static const char __pyx_k_No_value_specified_for_struct_at[] = "No value specified for struct attribute 'bits'";
static const char __pyx_k_No_value_specified_for_struct_at_2[] = "No value specified for struct attribute 'score'";
 ...
 */
  __pyx_t_1 = ((__pyx_v_b->game_result == __pyx_v_5board_YELLOW) != 0);
  if (__pyx_t_1) {
 ...
 */
    __pyx_r = (0x1068 - __pyx_f_8evaluate_popcount(__pyx_v_b->yellow_bitboard));
    goto __pyx_L0;
 ...
 */
  __pyx_t_2 = __pyx_v_8evaluate_PIECE_TABLE.begin();
  for (;;) {
    if (!(__pyx_t_2 != __pyx_v_8evaluate_PIECE_TABLE.end())) break;
    __pyx_t_3 = *__pyx_t_2;
    ++__pyx_t_2;
 ...
 * 
 * @cname("__pyx_convert__from_py_struct____pyx_t_8evaluate_bits_score_pair")
 * cdef struct_type __pyx_convert__from_py_struct____pyx_t_8evaluate_bits_score_pair(obj) except *:             # <<<<<<<<<<<<<<
 *     cdef struct_type result
 *     if not PyMapping_Check(obj):
 */

static struct __pyx_t_8evaluate_bits_score_pair __pyx_convert__from_py_struct____pyx_t_8evaluate_bits_score_pair(PyObject *__pyx_v_obj) {
  struct __pyx_t_8evaluate_bits_score_pair __pyx_v_result;
  PyObject *__pyx_v_value = NULL;
  struct __pyx_t_8evaluate_bits_score_pair __pyx_r;
  ...
  __Pyx_RefNannySetupContext("__pyx_convert__from_py_struct____pyx_t_8evaluate_bits_score_pair", 0);
 ...
 *         value = obj['bits']             # <<<<<<<<<<<<<<
 *     except KeyError:
 *         raise ValueError("No value specified for struct attribute 'bits'")
 */
      __pyx_t_2 = __Pyx_PyObject_Dict_GetItem(__pyx_v_obj, __pyx_n_s_bits); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 17, __pyx_L4_error)
      __Pyx_GOTREF(__pyx_t_2);
 ...
 */
    ...
    if (__pyx_t_6) {
      __Pyx_AddTraceback("FromPyStructUtility.__pyx_convert__from_py_struct____pyx_t_8evaluate_bits_score_pair", __pyx_clineno, __pyx_lineno, __pyx_filename);
 ...
 *         value = obj['score']
 */
  __pyx_t_10 = __Pyx_PyInt_As_unsigned_PY_LONG_LONG(__pyx_v_value); if (unlikely((__pyx_t_10 == (unsigned PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(1, 20, __pyx_L1_error)
  __pyx_v_result.bits = __pyx_t_10;
 ...
 */
      __pyx_t_8 = __Pyx_PyObject_Dict_GetItem(__pyx_v_obj, __pyx_n_s_score); if (unlikely(!__pyx_t_8)) __PYX_ERR(1, 22, __pyx_L12_error)
      __Pyx_GOTREF(__pyx_t_8);
...
/* "vector.from_py":45
 * 
 * @cname("__pyx_convert_vector_from_py_struct____pyx_t_8evaluate_bits_score_pair")
 * cdef vector[X] __pyx_convert_vector_from_py_struct____pyx_t_8evaluate_bits_score_pair(object o) except *:             # <<<<<<<<<<<<<<
 *     cdef vector[X] v
 *     for item in o:
 */

static std::vector<struct __pyx_t_8evaluate_bits_score_pair>  __pyx_convert_vector_from_py_struct____pyx_t_8evaluate_bits_score_pair(PyObject *__pyx_v_o) {
  std::vector<struct __pyx_t_8evaluate_bits_score_pair>  __pyx_v_v;
  PyObject *__pyx_v_item = 0;
  std::vector<struct __pyx_t_8evaluate_bits_score_pair>  __pyx_r;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  Py_ssize_t __pyx_t_2;
  PyObject *(*__pyx_t_3)(PyObject *);
  PyObject *__pyx_t_4 = NULL;
  struct __pyx_t_8evaluate_bits_score_pair __pyx_t_5;
  __Pyx_RefNannySetupContext("__pyx_convert_vector_from_py_struct____pyx_t_8evaluate_bits_score_pair", 0);
 ...
 * 
 */
    __pyx_t_5 = __pyx_convert__from_py_struct____pyx_t_8evaluate_bits_score_pair(__pyx_v_item); if (unlikely(PyErr_Occurred())) __PYX_ERR(1, 48, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("vector.from_py.__pyx_convert_vector_from_py_struct____pyx_t_8evaluate_bits_score_pair", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_pretend_to_initialize(&__pyx_r);
  __pyx_L0:;
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "evaluate",
    __pyx_k_file_evaluate_py_description_co, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static int __Pyx_modinit_global_init_code(void) {
  ...
  /*--- Global init code ---*/
  __pyx_v_8evaluate__piece_table = ((PyObject*)Py_None); Py_INCREF(Py_None);
  __pyx_v_8evaluate__piece_table_values = ((PyObject*)Py_None); Py_INCREF(Py_None);
  __pyx_v_8evaluate__temp_piece_table = ((PyObject*)Py_None); Py_INCREF(Py_None);
  __pyx_7genexpr__pyx_v_8evaluate_s = Py_None; Py_INCREF(Py_None);
  __Pyx_RefNannyFinishContext();
  return 0;
}
...
#endif
{
  ...
  std::vector<struct __pyx_t_8evaluate_bits_score_pair>  __pyx_t_12;
  int __pyx_t_13;
  __pyx_t_5board_bitboard __pyx_t_14;
  __Pyx_RefNannyDeclarations
  #if CYTHON_PEP489_MULTI_PHASE_INIT
  if (__pyx_m) {
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("evaluate", __pyx_methods, __pyx_k_file_evaluate_py_description_co, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "evaluate")) {
      if (unlikely(PyDict_SetItemString(modules, "evaluate", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_INCREF(__pyx_int_49);
  __Pyx_GIVEREF(__pyx_int_49);
  PyList_SET_ITEM(__pyx_t_1, 4, __pyx_int_49);
  __Pyx_INCREF(__pyx_int_31);
  __Pyx_GIVEREF(__pyx_int_31);
  ...
  PyList_SET_ITEM(__pyx_t_1, 9, __pyx_int_43);
  __Pyx_INCREF(__pyx_int_61);
  __Pyx_GIVEREF(__pyx_int_61);
  PyList_SET_ITEM(__pyx_t_1, 10, __pyx_int_61);
  __Pyx_INCREF(__pyx_int_61);
  __Pyx_GIVEREF(__pyx_int_61);
  PyList_SET_ITEM(__pyx_t_1, 11, __pyx_int_61);
  __Pyx_INCREF(__pyx_int_43);
  __Pyx_GIVEREF(__pyx_int_43);
  PyList_SET_ITEM(__pyx_t_1, 12, __pyx_int_43);
  __Pyx_INCREF(__pyx_int_31);
  __Pyx_GIVEREF(__pyx_int_31);
  PyList_SET_ITEM(__pyx_t_1, 13, __pyx_int_31);
  __Pyx_INCREF(__pyx_int_0);
  __Pyx_GIVEREF(__pyx_int_0);
  PyList_SET_ITEM(__pyx_t_1, 14, __pyx_int_0);
  __Pyx_INCREF(__pyx_int_49);
  __Pyx_GIVEREF(__pyx_int_49);
  PyList_SET_ITEM(__pyx_t_1, 15, __pyx_int_49);
  __Pyx_INCREF(__pyx_int_61);
  __Pyx_GIVEREF(__pyx_int_61);
  PyList_SET_ITEM(__pyx_t_1, 16, __pyx_int_61);
  __Pyx_INCREF(__pyx_int_88);
  __Pyx_GIVEREF(__pyx_int_88);
  PyList_SET_ITEM(__pyx_t_1, 17, __pyx_int_88);
  __Pyx_INCREF(__pyx_int_88);
  __Pyx_GIVEREF(__pyx_int_88);
  PyList_SET_ITEM(__pyx_t_1, 18, __pyx_int_88);
  __Pyx_INCREF(__pyx_int_61);
  __Pyx_GIVEREF(__pyx_int_61);
  PyList_SET_ITEM(__pyx_t_1, 19, __pyx_int_61);
  __Pyx_INCREF(__pyx_int_49);
  __Pyx_GIVEREF(__pyx_int_49);
  ...
  PyList_SET_ITEM(__pyx_t_1, 22, __pyx_int_81);
  __Pyx_INCREF(__pyx_int_93);
  __Pyx_GIVEREF(__pyx_int_93);
  PyList_SET_ITEM(__pyx_t_1, 23, __pyx_int_93);
  __Pyx_INCREF(__pyx_int_120);
  __Pyx_GIVEREF(__pyx_int_120);
  PyList_SET_ITEM(__pyx_t_1, 24, __pyx_int_120);
  __Pyx_INCREF(__pyx_int_120);
  __Pyx_GIVEREF(__pyx_int_120);
  PyList_SET_ITEM(__pyx_t_1, 25, __pyx_int_120);
  __Pyx_INCREF(__pyx_int_93);
  __Pyx_GIVEREF(__pyx_int_93);
  PyList_SET_ITEM(__pyx_t_1, 26, __pyx_int_93);
  __Pyx_INCREF(__pyx_int_81);
  __Pyx_GIVEREF(__pyx_int_81);
  PyList_SET_ITEM(__pyx_t_1, 27, __pyx_int_81);
  __Pyx_INCREF(__pyx_int_0);
  __Pyx_GIVEREF(__pyx_int_0);
  ...
  __Pyx_INCREF(__pyx_int_61);
  __Pyx_GIVEREF(__pyx_int_61);
  PyList_SET_ITEM(__pyx_t_1, 30, __pyx_int_61);
  __Pyx_INCREF(__pyx_int_88);
  __Pyx_GIVEREF(__pyx_int_88);
  PyList_SET_ITEM(__pyx_t_1, 31, __pyx_int_88);
  __Pyx_INCREF(__pyx_int_88);
  __Pyx_GIVEREF(__pyx_int_88);
  PyList_SET_ITEM(__pyx_t_1, 32, __pyx_int_88);
  __Pyx_INCREF(__pyx_int_61);
  __Pyx_GIVEREF(__pyx_int_61);
  PyList_SET_ITEM(__pyx_t_1, 33, __pyx_int_61);
  __Pyx_INCREF(__pyx_int_49);
  __Pyx_GIVEREF(__pyx_int_49);
  PyList_SET_ITEM(__pyx_t_1, 34, __pyx_int_49);
  __Pyx_INCREF(__pyx_int_0);
  __Pyx_GIVEREF(__pyx_int_0);
  ...
  __Pyx_INCREF(__pyx_int_43);
  __Pyx_GIVEREF(__pyx_int_43);
  PyList_SET_ITEM(__pyx_t_1, 37, __pyx_int_43);
  __Pyx_INCREF(__pyx_int_61);
  __Pyx_GIVEREF(__pyx_int_61);
  PyList_SET_ITEM(__pyx_t_1, 38, __pyx_int_61);
  __Pyx_INCREF(__pyx_int_61);
  __Pyx_GIVEREF(__pyx_int_61);
  PyList_SET_ITEM(__pyx_t_1, 39, __pyx_int_61);
  __Pyx_INCREF(__pyx_int_43);
  __Pyx_GIVEREF(__pyx_int_43);
  PyList_SET_ITEM(__pyx_t_1, 40, __pyx_int_43);
  __Pyx_INCREF(__pyx_int_31);
  __Pyx_GIVEREF(__pyx_int_31);
  PyList_SET_ITEM(__pyx_t_1, 41, __pyx_int_31);
  __Pyx_INCREF(__pyx_int_0);
  __Pyx_GIVEREF(__pyx_int_0);
  ...
  __Pyx_INCREF(__pyx_int_31);
  __Pyx_GIVEREF(__pyx_int_31);
  PyList_SET_ITEM(__pyx_t_1, 44, __pyx_int_31);
  __Pyx_INCREF(__pyx_int_49);
  __Pyx_GIVEREF(__pyx_int_49);
  PyList_SET_ITEM(__pyx_t_1, 45, __pyx_int_49);
  __Pyx_INCREF(__pyx_int_49);
  __Pyx_GIVEREF(__pyx_int_49);
  PyList_SET_ITEM(__pyx_t_1, 46, __pyx_int_49);
  __Pyx_INCREF(__pyx_int_31);
  __Pyx_GIVEREF(__pyx_int_31);
  PyList_SET_ITEM(__pyx_t_1, 47, __pyx_int_31);
  __Pyx_INCREF(__pyx_int_23);
  __Pyx_GIVEREF(__pyx_int_23);
  PyList_SET_ITEM(__pyx_t_1, 48, __pyx_int_23);
  __Pyx_XGOTREF(__pyx_v_8evaluate__piece_table);
  __Pyx_DECREF_SET(__pyx_v_8evaluate__piece_table, ((PyObject*)__pyx_t_1));
 ...
 */
  { /* enter inner scope */
    ...
    __Pyx_DECREF_SET(__pyx_7genexpr__pyx_v_8evaluate_s, Py_None);
  ...
  __Pyx_XGOTREF(__pyx_v_8evaluate__temp_piece_table);
  __Pyx_DECREF_SET(__pyx_v_8evaluate__temp_piece_table, ((PyObject*)__pyx_t_1));
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;
